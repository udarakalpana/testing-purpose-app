...
const navItems: NavItem[] = [
  ...
  { label: 'Users', to: '/dashboard/users', icon: 'M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm-8 8a8 8 0 0 1 16 0H4Z', adminOnly: true },
...
export default function Sidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  /*
   * Hiding an entry is presentation only. The API refuses the same request with
   * a 403 whatever the sidebar happens to show.
   */
